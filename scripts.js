...
const CONFIG = {
    ...
    SHEET_API_URL: 'https://script.google.com/macros/s/AKfycbymZewOn997d_6zlq4aZv6qVumIcmwx-cg4f3urlhc-DAKRFobzE1Vbq2ExQYMnc1zZ/exec',
...
async function deleteData(id) {
    ...
    try {
        if (CONFIG.USE_LOCAL_STORAGE) {
            ...
            formData.append('data', JSON.stringify({ rowIndex: film.rowIndex }));
